    ...
    companion object {
        val Dark =
            SyntaxTheme(
                ...
                error = SpanStyle(color = Color(0xFFF44747)),
                bracket = SpanStyle(color = Color(0xFFFFD700)),
                property = SpanStyle(color = Color(0xFF9CDCFE)),
                mongoOperator = SpanStyle(color = Color(0xFFC586C0)),
                esQueryType = SpanStyle(color = Color(0xFF4FC1FF)),
                parameter = SpanStyle(color = Color(0xFFFF8C00)),
            )

        val Light =
            SyntaxTheme(
                keyword = SpanStyle(color = Color(0xFF0000FF), fontWeight = FontWeight.Bold),
                string = SpanStyle(color = Color(0xFFA31515)),
                number = SpanStyle(color = Color(0xFF098658)),
                operator = SpanStyle(color = Color(0xFF000000)),
                identifier = SpanStyle(color = Color(0xFF001080)),
                function = SpanStyle(color = Color(0xFF795E26)),
                type = SpanStyle(color = Color(0xFF267F99)),
                comment = SpanStyle(color = Color(0xFF008000), fontStyle = FontStyle.Italic),
                error = SpanStyle(color = Color(0xFFFF0000)),
                bracket = SpanStyle(color = Color(0xFF0431FA)),
                property = SpanStyle(color = Color(0xFF001080)),
                mongoOperator = SpanStyle(color = Color(0xFFAF00DB)),
                esQueryType = SpanStyle(color = Color(0xFF0070C1)),
                parameter = SpanStyle(color = Color(0xFFFF6600)),
            )
    }
}
